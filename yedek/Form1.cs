    ...
    public partial class Form1 : Methods
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (checkBox1.Enabled && ((int.Parse(textBox1.Text)) > 0 && (int.Parse(textBox1.Text)) < 100))
            {
                ...
                if (((MaxHP * 100) / currentHP) < int.Parse(textBox1.Text))
                {
            ...
            if (checkBox2.Enabled && int.Parse(textBox2.Text) > 0 && int.Parse(textBox2.Text) < 100)
            {
                int MaxMP = CharMaxMP();
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.Parse(textBox1.Text) < 0) textBox1.Text = "0";
            else if (int.Parse(textBox1.Text) < 100) textBox1.Text = "100";
        }
